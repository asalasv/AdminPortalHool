...
# RUTA="/root/temporal"
# id_equipo=`mysql -h localhost -u root -pQu3l4d.114. -D portalhook -sN -e "select id_equipo from clientes where id_cliente='$1';"`
# hostname=`mysql -h localhost -u root -pQu3l4d.114. -D portalhook -sN -e "select hostname from equipos where id_equipo='$id_equipo';"`
...
# foto_publicidad=`mysql -h localhost -u root -pQu3l4d.114. -D portalhook -sN -e "select imagen_publicidad from portales_cliente where id_cliente='$1' and id_portal_cliente='$6';"`
...
# foto_logo=`mysql -h localhost -u root -pQu3l4d.114. -D portalhook -sN -e "select imagen_logo from portales_cliente where id_portal_cliente='$1' and id_portal_cliente='$6';"`
# echo $hostname
# cp /var/www/html/images/$foto_publicidad /tmp/$1-$6-captiveportal-publicidad.jpg
# cp /var/www/html/images/$foto_logo /tmp/$1-$6-captiveportal-logo.png
...
# scp -p 22010 /tmp/$1-$6-captiveportal-publicidad.jpg root@$hostname:$RUTA/$1-$6/captiveportal-publicidad.jpg
